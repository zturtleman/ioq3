...
#define CTF_RETURN_FLAG_ASSIST_BONUS		0	// awarded for returning a flag that causes a capture to happen almost immediately
#define CTF_FRAG_CARRIER_ASSIST_BONUS		0	// award for fragging a flag carrier if a capture happens almost immediately
